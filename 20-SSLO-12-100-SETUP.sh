...
curl --silent https://raw.githubusercontent.com/f5education/$COURSE_ID/main/sslo12-base-v12-beta.scf --output /tmp/sslo12-base-v12-beta.scf
sudo scp /tmp/*.scf 192.168.1.31:/var/local/scf

# copy BIG-IP setup script from Github to bigip1
curl --silent https://raw.githubusercontent.com/f5education/$COURSE_ID/main/sslo12_bigip_setup_1.0.sh --output /tmp/sslo12_bigip_setup_1.0.sh
